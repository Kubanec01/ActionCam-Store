  ...
  return (
    <div className="sm:mt-[10.625rem] w-[90%] max-w-[1500px] flex justify-center flex-col p-4">
      <div className="flex justify-center items-center flex-col text-center">
        <h1
          className="text-[#fffffff7] text-7xl mx-auto mb-[30px] max-w-[43.75rem] relative
        ...
        <p className="lg:w-[50%] w-[80%] mx-auto lg:text-lg text-xl text-[#ffffff87] mb-[2.5rem]">
      ...
      <div className="md:w-[76.2%] sm:mt-[1.875rem] mt-[4rem] md:mx-auto ml-[1.875rem]">
        <motion.h2
          initial="hidden"
          whileInView="visible"
          viewport={{
        ...
        <motion.p
          ...
          className="text-[#ffffff9a] md:text-xl text-2xl md:w-[70%] mt-[0.313rem]"
        >
